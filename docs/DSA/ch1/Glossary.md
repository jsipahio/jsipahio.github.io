...
- **Refactoring** - The process of modifying the structure of source code in a way that does not impact functionality. Typically, refactorings are done to improve the quality and/or readability of the code without impacting its use.
