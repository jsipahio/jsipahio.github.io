...
An updated version of this glossary will be included with each week to reflect new terms I introduce. If I say or write something during a lecture, and you don't know what it means, try checking here first. T
